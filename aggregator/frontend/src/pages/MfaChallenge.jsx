...
export default function MfaChallenge() {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#09090b', color: '#f8fafc', fontFamily: 'Inter, sans-serif', padding: '20px' }}>
      <div style={{ background: '#18181b', width: '100%', maxWidth: '380px', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.08)', padding: '40px', boxShadow: '0 24px 48px rgba(0,0,0,0.4)', position: 'relative' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <div style={{ fontSize: '24px', fontWeight: 800, letterSpacing: '-0.5px', color: '#fff' }}>Two-Factor Auth</div>
          <div style={{ fontSize: '12px', color: '#94a3b8', fontFamily: 'JetBrains Mono, monospace', marginTop: '4px' }}>Verify your identity</div>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ marginBottom: '20px' }}>
            <label style={{ display: 'block', fontSize: '11px', fontWeight: 600, color: '#94a3b8', marginBottom: '8px', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Authentication Code</label>
            <div style={{ position: 'relative' }}>
              ...
              <input 
                ...
                style={{ width: '100%', padding: '11px 14px 11px 42px', background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '10px', color: '#ffffff', fontFamily: 'Inter, sans-serif', textAlign: 'center', letterSpacing: '4px', fontSize: '16px', fontWeight: 700, outline: 'none', transition: 'all .2s' }}
                onFocus={(e) => { e.target.style.borderColor = 'rgba(37,99,235,0.7)'; e.target.style.background = 'rgba(37,99,235,0.05)'; e.target.style.boxShadow = '0 0 0 3px rgba(37,99,235,0.15)'; }}
