    ...
    <div style={{ width: '100%', paddingBottom: '40px', position: 'relative' }}>
      ...
      <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: '8px', padding: '14px 20px', display: 'flex', flexWrap: 'nowrap', alignItems: 'center', gap: '12px', marginBottom: '20px', justifyContent: 'space-between', overflowX: 'auto' }}>
        ...
        >
          ...
          <option value="group">Group Modification</option>
          <option value="locked">Account Locked</option>
        </select>

        <label style={{ display: 'flex', alignItems: 'center', gap: '6px', fontSize: '11px', color: 'var(--text)', cursor: 'pointer', fontFamily: 'var(--sans)', userSelect: 'none' }}>
          <input 
            type="checkbox" 
            checked={privilegedFilter === 'true'} 
            onChange={(e) => { setPrivilegedFilter(e.target.checked ? 'true' : 'false'); setPage(1); }}
